...
public abstract class Property<T extends Comparable<T>> {
   ...
   private final Codec<Property.Value<T>> valueCodec = this.codec.xmap(this::value, Property.Value::pValue);
   ...
   public static record Value<T extends Comparable<T>>(Property<T> pProperty, T pValue) {
      public Value(Property<T> pProperty, T pValue) {
      ...
      public String toString() {
         return this.pProperty.getName() + "=" + this.pProperty.getName(this.pValue);
      }
   }
}