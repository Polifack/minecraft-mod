...
public class ParticleEngine implements PreparableReloadListener {
   ...
   public void destroy(BlockPos pPos, BlockState pState) {
      if (!pState.isAir() && !net.minecraftforge.client.RenderProperties.get(pState).addDestroyEffects(pState, this.level, pPos, this)) {
   ...
   static class MutableSpriteSet implements SpriteSet {
      ...
      public TextureAtlasSprite get(Random pRand) {
         return this.sprites.get(pRand.nextInt(this.sprites.size()));
      }
