...
public class LocationPredicate {
   ...
   public LocationPredicate(MinMaxBounds.Doubles pX, MinMaxBounds.Doubles pY, MinMaxBounds.Doubles pZ, @Nullable ResourceKey<Biome> pBiome, @Nullable StructureFeature<?> pFeature, @Nullable ResourceKey<Level> pDimension, @Nullable Boolean pSmokey, LightPredicate pLight, BlockPredicate pBlock, FluidPredicate pFluid) {
      this.x = pX;
      this.y = pY;
      this.z = pZ;
      this.biome = pBiome;
   ...
   public static class Builder {
      ...
      public LocationPredicate.Builder setFeature(@Nullable StructureFeature<?> pFeature) {
         this.feature = pFeature;
         return this;
      }
